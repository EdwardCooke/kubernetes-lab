...
echo "Configuring Kubernetes installer"
echo '
apiVersion: kubeadm.k8s.io/v1beta3
kind: ClusterConfiguration
controlPlaneEndpoint: "kube2.k8s.lan:6443"
dns:
  imageRepository: "kubernetes.k8s.lan/coredns"
imageRepository: "kubernetes.k8s.lan"
clusterName: "kube2"
